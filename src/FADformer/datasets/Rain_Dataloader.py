...
class TrainData_for_Rain100H(data.Dataset):
    def __init__(self, crop_size, train_data_dir, only_h_flip=False):
        super().__init__()
        train_list_rain = './datasets/Rain100/rain_data_train_Heavy/rain/X2/LIST.TXT'
...
class TrainData_for_Rain100L(data.Dataset):
    def __init__(self, crop_size, train_data_dir, only_h_flip=False):
        super().__init__()
        train_list_rain = './datasets/Rain100/rain_data_train_Light/rain/LIST.TXT'
...
class TestData_for_Rain100H(data.Dataset):
    def __init__(self, local_size, val_data_dir, flag=True):
        ...
        val_list_rain = "./datasets/Rain100/rain_heavy_test/rain/X2/LIST.TXT"
...
class TestData_for_Rain100H_pad(data.Dataset):
...
class TestData_for_Rain100L(data.Dataset):
    def __init__(self, local_size, val_data_dir, flag=True):
        ...
        val_list_rain = "./datasets/Rain100/rain_data_test_Light/rain/X2/LIST.TXT"
...
class TestData_for_Rain100L_pad(data.Dataset):
    def __init__(self, val_data_dir, flag=True):
        super().__init__()
