...
class TrainData(data.Dataset):
    def __init__(self, crop_size, train_data_dir, only_h_flip=False):
        super().__init__()
        train_list_rain = './datasets/Raindrop/raindrop_train.txt'
...
class Test_a(data.Dataset):
    def __init__(self, val_data_dir, flag=True):
        ...
        val_list_haze = './datasets/Raindrop/raindrop_test_a.txt'
...
class Test_b(data.Dataset):
    def __init__(self, val_data_dir, flag=True):
        super().__init__()
        val_list_rain = "./datasets/Raindrop/raindrop_test_b.txt"
