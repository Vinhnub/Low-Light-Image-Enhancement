...
if __name__ == '__main__':
    ...
    network.load_state_dict(torch.load(
        'E:/PythonFile/Project/Low-Light-Image-Enhancement/src/FADformer/weight/FADformer_Rain200L.pth')[
                                'state_dict'])

    root_dir = 'E:/PythonFile/Project/Low-Light-Image-Enhancement/paper_image/result_testdata/CIDNet_replace_LCA_to_MMMamba/Result'
    result_dir = 'E:/PythonFile/Project/Low-Light-Image-Enhancement/paper_image/result_testdata/CIDNet_replace_LCA_to_MMMamba/Result_Denoised'
