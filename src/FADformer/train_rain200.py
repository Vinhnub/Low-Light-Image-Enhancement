...
if __name__ == '__main__':
    ...
    # you can change the dir to your own dataset
    train_dir = './datasets/Rain100/rain_data_train_Heavy'
    test_dir = './datasets/Rain100/rain_heavy_test'
    ...
    # you can change test_str when you development your own exp, e.g. add "_lr_1e-4_xx_xxx_" to build ablation exp
