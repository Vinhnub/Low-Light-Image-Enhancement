...
from datasets.DDN_Dataloader import TrainData_for_DDN, TestData_for_DDN
from numpy import *
...
parser.add_argument('--exp', default='ddn', type=str, help='experiment setting')
...
if __name__ == '__main__':
    ...
    train_dir = './datasets/DDN-Data/train'
    test_dir = './datasets/DDN-Data/test'
    train_dataset = TrainData_for_DDN(256, train_dir)
    ...
    test_dataset = TestData_for_DDN(8, test_dir)
