...
def main():
    parser = argparse.ArgumentParser(description="Test CIDNet_base and visualize feature maps")
    parser.add_argument('--image_path', type=str, required=True, help='Path to the input image')
    parser.add_argument('--weight_path', type=str, default='weights/best_model_base.pth', help='Path to the model weights (optional)')
    parser.add_argument('--output_dir', type=str, default='results/feature_maps_base', help='Directory to save visualizations')
