...
from net.CIDNet_2Stage import CIDNetTwoStage
...
def eval(model, testing_data_loader, model_path, output_folder,norm_size=True,LOL=False,v2=False,unpaired=False,alpha=1.0,gamma=1.0):
    ...
    for batch in tqdm(testing_data_loader):
        with torch.no_grad():
            ...
            # Forward pass: 2-stage model returns the final enhanced image
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./output_2stage'):          
            os.makedirs('./output_2stage', exist_ok=True)  
    ...
    if ep.lol:
        ...
        output_folder = './output_2stage/LOLv1/'
        if ep.perc:
            weight_path = './weights/LOLv1/w_perc.pth'
        else:
            # Change this to point to your 2-stage trained model
            weight_path = './weights/train_2stage/epoch_200.pth'
        ...
        output_folder = './output_2stage/LOLv2_real/'
        if ep.best_GT_mean:
        ...
        output_folder = './output_2stage/LOLv2_syn/'
        if ep.perc:
        ...
        output_folder = './output_2stage/SICE_grad/'
        ...
        output_folder = './output_2stage/SICE_mix/'
        weight_path = './weights/SICE.pth'
        norm_size = False
        ...
        output_folder = './output_2stage/fivek/'
