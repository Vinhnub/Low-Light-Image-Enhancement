...
def enhance_images(
    ...
    with torch.no_grad():
        for image_path in tqdm(image_paths, desc="Testing"):
            ...
            output_image.save(output_dir / image_path.name)
...
def parse_args():
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="./weights/train/epoch_160.pth",
...
def main():
    ...
    if args.gt_dir:
        run_metrics(args.output_dir, args.gt_dir, args.use_GT_mean)
