...
from data.LOLdataset_2stage import *
...
def get_lol_training_set(data_dir, gt_s1_dir, size):
    return LOLDatasetFromFolder2Stage(data_dir, gt_s1_dir, transform=transform1(size))


def get_lol_v2_training_set(data_dir, gt_s1_dir, size):
    return LOLv2DatasetFromFolder2Stage(data_dir, gt_s1_dir, transform=transform1(size))


def get_lol_v2_syn_training_set(data_dir, gt_s1_dir, size):
    return LOLv2SynDatasetFromFolder2Stage(data_dir, gt_s1_dir, transform=transform1(size))
