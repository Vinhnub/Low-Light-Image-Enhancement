...
def option():
    # Training settings
    parser = argparse.ArgumentParser(description='CIDNet 2-Stage')
    ...
    parser.add_argument('--data_val_lol_v1'         , type=str, default='E:/Pythonfile/Low-Light-Image-Enhancement/mydata/dataset/dataset/LOLv1/test/low')
    ...
    parser.add_argument('--data_valgt_lol_v1'       , type=str, default='E:/Pythonfile/Low-Light-Image-Enhancement/mydata/dataset/dataset/LOLv1/test/high/')
    ...
    parser.add_argument('--s1_HVI_weight', type=float, default=1.0)
    parser.add_argument('--s1_L1_weight', type=float, default=1.0)
    parser.add_argument('--s1_D_weight',  type=float, default=0.5)
    parser.add_argument('--s1_E_weight',  type=float, default=50.0)
    parser.add_argument('--s1_P_weight',  type=float, default=0)
    parser.add_argument('--s1_LSGD_weight', type=float, default=1.0)
    
    # Stage 2 loss weights
    parser.add_argument('--s2_HVI_weight', type=float, default=1.0)
    parser.add_argument('--s2_L1_weight', type=float, default=1.0)
    parser.add_argument('--s2_D_weight',  type=float, default=0.5)
    ...
    parser.add_argument('--lambda1', type=float, default=0.4, help='Stage 1 loss weight in joint training')
    parser.add_argument('--lambda2', type=float, default=1.0, help='Stage 2 loss weight in joint training')
    parser.add_argument('--stop_grad', type=_str2bool, default=False, help='Stop gradients flowing from Stage 2 back to Stage 1')
