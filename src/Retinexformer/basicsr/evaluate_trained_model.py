...
def load_retinexformer(model_path, device):
    ...
    # ---------------------------------
    # infer n_feat automatically
    # intro conv weight shape
    # ---------------------------------
    intro_weight = cleaned_state_dict[
        "body.0.estimator.conv1.weight"
    ]

    n_feat = intro_weight.shape[0]

    print(f"Detected n_feat = {n_feat}")
...
def parse_args():
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="E:/PythonFile/Project/Low-Light-Image-Enhancement/src/Retinexformer/experiments/LoL_v1/base/model_weight/best_psnr_23.63_96000.pth",
